...
|.........B7 Admin WEB FINDER ..........|
+-----------------------------------------+
|#Author:     PRO  Faisal jhnmr-LFH      |
|#Contact: twiiter@pro1faisal    |
|#Date:         2020             |
...
for hani in passe :
    ...
    try :
        ...
        print("                                                             ")
        print("\033[92m :::: ALERTE::: B7 ADMIN PAGE ITS FOUND ::: "+curl)
        print("_____________________________________________________________")
...
print ("----------------------------------------------------------------------------------------")
print ("\033[93m     i HOPE I HAVE HELPED YOU ^_^ , TY FOR USE MY SCRIPT -PRO1 Faisal-")
print ("---
